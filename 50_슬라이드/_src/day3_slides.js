...
s.addNotes("확정 설계: X 수정 차단은 리터럴 메시지이며 023을 만들지 않는다. 예상 질문 — Q. 모든 메시지를 클래스에? A. 제품 코드는 클래스가 유리하나, 이 과정은 차이를 보여주기 위해 섞는다.");
...
shot(s, { x: 7.45, y: 1.85, w: 5.35, h: 4.55, id: "D3-03", cap: "SE41 — Application Toolbar에\n기능 코드 3개(등록/수정/삭제) 입력" });
...
shot(s, { x: 7.65, y: 1.3, w: 5.15, h: 4.4, id: "D3-04", cap: "ZEDU##_U19 실행 — ALV 툴바에\n[등록][수정][삭제] 버튼 3개" });
...
shot(s, { x: 8.35, y: 3.45, w: 4.45, h: 2.4, id: "D3-05", cap: "POPUP_GET_VALUES —\n주문 등록 입력 팝업" });
...
s.addNotes("확정 설계: X 차단은 리터럴, 메시지 023 없음. TODO A는 U19 패턴 재적용 — 여기서 막히면 U19 콜백 FORM을 다시 보게 안내.");
...
banner(s, 0.55, 4.5, 12.25, "지키는 것: X 차단은 리터럴 · 메시지 023 없음 · 취소 기능은 기본 과정에 추가하지 않음(확장 1)", {});
...
shot(s, { x: 8.35, y: 3.45, w: 4.45, h: 2.4, id: "D3-06", cap: "POPUP_TO_CONFIRM —\n\"삭제하시겠습니까?\" 확인 팝업" });
