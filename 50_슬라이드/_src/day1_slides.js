...
card(s, 8.75, 3.6, 4.05, 1.5, "다 풀었다면", "퀴즈집 D02\n(어려웠다면 E02)", { fill: "FDF3E3", tColor: "9A6A12", bSize: 12 });
...
card(s, 7.6, 1.85, 5.2, 2.4, "다 풀었다면", "퀴즈집 D03 (심화)\n어려웠다면 E03", { fill: "FDF3E3", tColor: "9A6A12", bSize: 12.5 });
...
s.addNotes("완료자는 퀴즈집 D04. 남은 10분 내 미완료여도 U05 진행에 지장 없음.");
...
s.addNotes("방금 한 것의 반복이라 대부분 완주 가능. 완료자는 퀴즈집 D06.");
