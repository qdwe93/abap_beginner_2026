...
card(s, 8.75, 3.5, 4.05, 1.3, "다 풀었다면", "퀴즈집 D09\n(어려웠다면 E09) · 정답은 부록 A", { fill: "FDF3E3", tColor: "9A6A12", bSize: 12 });
...
card(s, 8.85, 1.8, 3.95, 3.0, "다 풀었다면", "퀴즈집 D10 (정렬 후 취소 제거)\n어려웠다면 E10\n\n정답은 부록 A —\n지금은 보지 않기!", { fill: "FDF3E3", tColor: "9A6A12", bSize: 12.5 });
...
card(s, 8.35, 1.8, 4.45, 3.0, "다 풀었다면", "퀴즈집 D13\n(수량 하한 + 상태 조건)\n어려웠다면 E13\n\n정답은 부록 A", { fill: "FDF3E3", tColor: "9A6A12", bSize: 12.5 });
...
card(s, 0.55, 4.3, 12.25, 1.1, "다 풀었다면", "퀴즈집 D14 (최근 30일 기본 범위) · 어려웠다면 E14 · 정답은 부록 A — 지금은 보지 않기!", { fill: "FDF3E3", tColor: "9A6A12", bSize: 13 });
...
card(s, 8.35, 1.8, 4.45, 3.0, "다 풀었다면", "퀴즈집 D15\n(합계·소계 do_sum 등)\n어려웠다면 E15\n\n정답은 부록 A", { fill: "FDF3E3", tColor: "9A6A12", bSize: 12.5 });
